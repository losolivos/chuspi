...
FUNCTION(GENERATE_CXX_PCH_COMMAND TARGET_NAME INCLUDE_FLAGS IN PCH_SRC OUT)
  ...
  SET(PCH_LIB_TARGET_NAME ${PCH_SRC_N}_dephelp)
  SET(PCH_FILE_HELPER ${CMAKE_CURRENT_BINARY_DIR}/${PCH_LIB_TARGET_NAME}.cpp)

  FILE(WRITE ${PCH_FILE_HELPER}
    "#include <${CMAKE_CURRENT_SOURCE_DIR}/${IN}>\nvoid dummy() { }"
  )

  ADD_LIBRARY(${PCH_LIB_TARGET_NAME} STATIC ${PCH_FILE_HELPER})

  ADD_CUSTOM_COMMAND(
    OUTPUT ${OUT}
    COMMAND ${CMAKE_CXX_COMPILER}
    ARGS ${DEFINITION_FLAGS} ${COMPILE_FLAGS} ${INCLUDE_FLAGS} -x c++-header ${IN} -o ${OUT}
    DEPENDS ${IN} ${PCH_LIB_TARGET_NAME}
