...
enum WorldStates
{
    ...
    WS_CONQUEST_RESET_TIME      = 20006                      // Next conquest reset time
};
...
class World
{
    public:
        ...
        uint32 GetMaxServerLatency() const { return m_updateTimeMax; }
        ...
        void InvalidatePlayerData(uint64 guid);

        void ResetCurrencyWeekCap();
        void ResetConquestCap();
    ...
    private:
        ...
        uint32 m_updateTimeLast, m_updateTimeAverage, m_updateTimeSum, m_updateTimeMax;
