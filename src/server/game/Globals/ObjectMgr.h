...
typedef std::unordered_map<uint32, ItemSpecialisationSet> ItemSpecialisationContainer;
...
typedef std::map<uint8, LFRLootBindSet> LFRLootBindGroupMap;
...
class ObjectMgr
{
    ...
    public:
        ...
        LFRLootBindSet const& GetLFRLootBindGroup(uint8 lootGroup);
    ...
    private:
        ...
        LFRLootBindGroupMap m_lfrLootGroupsLinked;
