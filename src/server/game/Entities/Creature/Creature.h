...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_PERSONAL_LOOT                   = 0x00010000,       // Custom: Personal Loot is used on this npc
    ...
    CREATURE_FLAG_EXTRA_VEHICLE_ATTACKABLE_PASSENGERS   = 0x80000000,       // creature is vehicle, UNIT_STATE_ONVEHICLE will not add to passengers
};
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_DISABLED_LOS | CREATURE_FLAG_EXTRA_VEHICLE_ATTACKABLE_PASSENGERS)
...
class Creature : public Unit, public GridObject<Creature>, public MapCreature
{
    public:
        ...
        bool isTagShared() const;
        bool hasLootRecipient() const;
        bool isTappedBy(Player const* player) const;                          // return true if the creature is tapped by the player or a member of his party.

        void sendPersonalRewards();
    ...
    protected:
        ...
        std::list<uint64> m_lootRecipientList;
