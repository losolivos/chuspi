...
class InstanceScript : public ZoneScript
{
    public:
        ...
        void DoRemoveAuraFromStackOnPlayers(uint32 spell, uint64 casterGUID = 0, AuraRemoveMode mode = AURA_REMOVE_BY_DEFAULT, int32 num = -1);
        ...
        void DoNearTeleportPlayers(Position pos);
