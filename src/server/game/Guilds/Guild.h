...
class Guild
{
    private:
        ...
        class Member
        {
            ...
            public:
                ...
                uint64 GetWeeklyActivity() const { return m_weekActivity; }
                uint64 GetMemberAchievementPoints() const { return m_achievementPoints; }
                uint32 GetWeeklyReputation() const { return m_weekReputation; }
                uint32 GetTotalReputaion() const { return m_totalReputation; }
    ...
    public:
        ...
        void SendUpdateMemberProfessions(Player* player);
        void GiveReputationToMember(Player* player, uint32 reputation);
