...
public:
    ...
    public:
        ...
        void ShiftEvolutions(uint32 m_uiEvolution)
        {
            ...
            Talk(urand(TALK_EVOLVE, TALK_EVOLVE_2));
...
public:
    ...
    public:
        ...
        void JustSummoned(Unit* summoner)
        {
            if (summoner->GetEntry() == BOSS_PRIMORDIUS)
                primordius = summoner->ToCreature();
        }
        ...
        void DamageTaken(Unit* /*pDealer*/, uint32& uiDamage)
        {
            if (uiDamage >= me->GetHealth())
            {
                ...
                {
                    if (primordius)
                        if (Creature* pStalker = primordius->SummonCreature(NPC_AT_STALKER, *me))
...
public:
    ...
    class sat_impl : public IAreaTriggerOnce
    {
        ...
        void OnTrigger(WorldObject* pTriggering)
        {
...
public:
    ...
    class sat_impl : public IAreaTriggerAura
    {
        ...
        void OnTriggeringUpdate(WorldObject* pTriggering)
        {
            if (Unit* pTarget = pTriggering->ToUnit())
            {
