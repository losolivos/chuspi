...
public:
    ...
    static bool HandleServerInfoCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        handler->PSendSysMessage("TC based 5.4 core");
        handler->PSendSysMessage(LANG_CONNECTED_USERS, activeClientsNum, maxActiveClientsNum, queuedClientsNum, maxQueuedClientsNum);
        handler->PSendSysMessage(LANG_UPTIME, uptime.c_str());
        handler->PSendSysMessage("Server latency: (Last: %u; Max: %u; Average: %u;) Timestamp: %u", sWorld->GetLastServerLatency(), sWorld->GetMaxServerLatency(), sWorld->GetAverageServerLatency(), time(NULL));
        ...
        handler->PSendSysMessage("Loaded grids count: %u (Creatures: %u)", sMapMgr->GetLoadedGrids(), sObjectAccessor->GetCreatureCount());
